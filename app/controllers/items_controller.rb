class ItemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @item.save
        format.html { redirect_to @item, 'Item was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @item.update(item_params)
        format.html { redirect_to items_url, 'Item was successfully updated.' }
  ...
  def destroy
    @item.destroy
    respond_to do |format|
      format.html { redirect_to items_url, 'Item was successfully destroyed.' }
